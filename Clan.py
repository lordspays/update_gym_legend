...
# ======================
# КОМАНДА ПОМОЩИ С КНОПКАМИ (ОБНОВЛЕННАЯ)
# ======================
...
async def clan_help_handler(message: Message):
    ...
    # 4-5. Третий ряд: Управление казной (справа) и Настройка клана (слева)
    keyboard.row()
    keyboard.add(Text("💲 Управление казной"), color=KeyboardButtonColor.PRIMARY)
    keyboard.add(Text("⚙️ Настройка клана"), color=KeyboardButtonColor.NEGATIVE)
...
@clan_labeler.message(text="⚙️ Настройка клана")
async def clan_settings_help_handler(message: Message):
    """Справка по настройке клана"""
    help_text = (
        "⚙️ НАСТРОЙКИ КЛАНА\n\n"
        "🎯 К улучшить 1\n"
        "🎯 К улучшить максимум\n"
